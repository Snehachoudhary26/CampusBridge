...
<p align="center">
  <img src="https://img.shields.io/badge/Status-Live%20%F0%9F%9F%A2-00C896?style=for-the-badge&logo=rocket&logoColor=white"/>
  &nbsp;
...
> ⚠️ **Note:** Backend is on Render free tier — first request may take 50 seconds to wake up. Subsequent requests are fast.
...
> 📖 Full interactive docs → **[campusbridge-2gsg.onrender.com/docs](https://campusbridge-2gsg.onrender.com/docs)**
...
2. Set **Root Directory** → `campusbridge/backend`
3. **Build Command** → `pip install -r requirements.txt`
4. **Start Command** → `uvicorn main:app --host 0.0.0.0 --port $PORT`
5. Add all environment variables from your `.env`
6. Create a free **Render PostgreSQL** database and use the Internal URL as `DATABASE_URL`
...
vercel --prod
```
Add `VITE_API_URL=https://your-render-url.onrender.com` in Vercel environment variables.
...
- **Fully deployed** — Live on Vercel + Render with cloud PostgreSQL database
...
<p align="center">
  ...
  &nbsp;
  <a href="https://campusbridge-one.vercel.app">
    <img src="https://img.shields.io/badge/Live_Demo-campusbridge--one.vercel.app-00C896?style=for-the-badge&logo=vercel&logoColor=white"/>
  </a>
</p>
